...
import { Button, message, Input, Drawer, Upload, Popover, Popconfirm } from 'antd';
  ...
  const columns: ProColumns<API.RuleListItem>[] = [
    ...
    },
    {
      ...
      render: (_, record) => [
        ...
        // <Popconfirm title="确认要删除吗？" icon={<QuestionCircleOutlined style={{ color: 'red' }} />} onConfirm={onConfirmDelete(record)}>
        //   <a href="#">删除</a>
        // </Popconfirm>,
        // <a onClick={}>
        //   删除
