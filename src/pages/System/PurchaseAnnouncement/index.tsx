...
import { getPurchaseAnnouncementList, updatePurchaseAnnouncement, createPurchaseAnnouncement, deletePurchaseAnnouncements } from '@/services/resources/api'
...
const PurchaseAnnouncement: React.FC = () => {
  /**
...
export default PurchaseAnnouncement;
